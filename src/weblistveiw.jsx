       ...
       <>
        ...
        <div className="flex w-[97%] ml-10  h-full max-sm:ml-3">
            ...
            <div className=" w-[20%] flex flex-col items-start justify-center  gap-4 pt-4 pl-4 pr-4 max-sm:hidden">
                ...
                <div>
                    <h1 className="text-2xl font-bold mt-4 cursor-pointer mb-4">Price range</h1>
                ...
                <div>
                    <h1 className="text-2xl font-bold mt-4 cursor-pointer mb-4 ">Ratings</h1>
            ...
            <div className=" w-[100%]  ">
                ...
                <div className="flex flex-col w-full h-full gap-4 pt-6 ">
                    {[camera, mobile, smartphone, myphone, ptop, watch].map((imgSrc, index) => (
                        <div key={index} className="w-full bg-white border border-[#99a3b0] rounded-lg flex flex-col md:flex-row p-4">
